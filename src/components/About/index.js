  ...
  return (
    <div className="aboutus" id="oquefazemos" data-aos='fade-left'>
      ...
      <div className="btns-stacks">
        <ButtonStacks dataAos='zoom-in-up' datAaosDuration="2000" icon={IconDesktop} title="Desenvolvimento de Sites" description="Desenvolvemos seu site com as melhores
          tencologias do mercado. Nossa ideia não é
          criar apenas mais um site, mas sim criar O SITE!" />

        <ButtonStacks dataAos='zoom-in-up' datAaosDuration="2000" icon={IconMobile} title="Desenvolvimento de Aplicativos" description="Desenvolvemos seu aplicativo com as melhores
